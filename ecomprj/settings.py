...
ALLOWED_HOSTS = ["*", "web-production-92f3.up.railway.app/admin", "web-production-92f3.up.railway.app"]
CSRF_TRUSTED_ORIGINS = ['https://web-production-92f3.up.railway.app/admin']

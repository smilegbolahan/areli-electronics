...
DATABASE_URL = "postgresql://postgres:ZFjTpzbCnfNlLphLQ0uU@containers-us-west-152.railway.app:5887/railway"
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://web-production-6740.up.railway.app/']
